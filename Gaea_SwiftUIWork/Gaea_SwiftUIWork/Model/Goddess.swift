...
var goddessDummy: [Goddess] = [
    Goddess(name: "Demeter",
            ...
            footerImage: URL(string: "Jacob Jordaens_Ofrenda a Ceres"),
            fotterImageDescription: "Jacob Jordaens <Ofrenda a Ceres>",
            type: .olympus),

    Goddess(name: "Artemis",
            image: URL(string:"Peter Paul Rubens_Diana cazadora")!,
    ...
    Goddess(name: "Venus",
            image: URL(string:"Cornelis Holsteyn_Venus de dood van Adonis bewenend")!,
    ...
    Goddess(name: "Amazones",
            image: URL(string:"Johann Georg_ Platzer Thalestris im Lager Alexander des Großen")!,
